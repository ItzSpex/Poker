...
namespace PokerHandEvaluator
{
    public class HandEvaluator
    {
        ...
        public PlayerBL Chair0 { get; set; }
        public PlayerBL Chair1 { get; set; }
        public PlayerBL Chair2 { get; set; }
        public PlayerBL Chair3 { get; set; }
        public PlayerBL Chair4 { get; set; }
        ...
        */
        ...
        public PlayerBL GetUserByIndex(int index)
        {
            switch (index)
            {
        ...
        public class SidePot
        {
            ...
            public List<PlayerBL> ContestedBy { get; set; }
            public List<PlayerBL> Winners { get; set; }
